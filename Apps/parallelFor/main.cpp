...
public:
    ...
    void operator()(const Range& range) const override
    {
        ...
        {
            int x = i % 8, y = i / 8;
            img(Range{ y * 100, (y + 1) * 100 }, Range{ x * 100, (x + 1) * 100 }) = color;
        }
    }
};
...
int main()
{
    Mat3b img = Mat3b::zeros(800,800);

    parallel_for_(Range{ 0, 64 }, RandomFillBody{ img },3);
...
int main()
{
    ...
    Mat mandelbrotImg(12000, 12000, CV_8U);
